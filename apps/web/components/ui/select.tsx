...
function SelectTrigger({ className, children, ...props }: SelectPrimitive.Trigger.Props) {
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        'border-cream-700 font-body focus-visible:border-cream-600 focus-visible:ring-3 focus-visible:ring-cream-700/30 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 data-placeholder:font-display data-placeholder:font-normal flex w-full select-none items-center justify-between gap-2 whitespace-nowrap rounded-[16px] border bg-white px-4 py-3 text-[14px] outline-none transition-colors disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
        className,
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon
        render={<ChevronDownIcon className="text-muted-foreground pointer-events-none shrink-0" />}
      />
    </SelectPrimitive.Trigger>
  )
}
